<div class="header-content">
	...
	<div class="breadcrumb-wrapper hidden-xs">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="<?= base_url() ?>clase">Gestión de clases</a> 
				<i class="fa fa-angle-right"></i>
			</li>
			<li class="active">
					...
					<form id="gJugadorClase" name="gJugadorClase">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<div class="row">
									<div class="col-md-12">
										<center><small><p>Aquí solo se cargaran los jugadores que tengan un plan de clases activo, la gestión de cada plan de clase se hace en las opciones de cada persona.</p></small></center>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 form-group">
