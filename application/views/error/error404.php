...
<head>
	...
	<title>Error 404 | RTSERVICES</title>
	...
	<link href="<?= base_url() ?>assets/css/error-page.css" rel="stylesheet">
...
<body>
	<div class="error-wrapper">
		<h1>404!</h1>
		<h3>Lo sentimos demasiado pero la pagina que buscas no existe!</h3>
		<h4>Lamentamos esto enserio, pero no existe lo que buscas. <br> <br/></h4>
		<div class="form-group has-feedback no-padding">
			<a href="<?= base_url() ?>login"><button type="submit" class="btn btn-theme">Salir de aqui</button></a>
		</div>
	</div>
</body>
</html>